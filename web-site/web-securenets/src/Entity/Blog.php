...
class Blog
{
     ...
     */
    #[Groups(['read:collection','read:item','put:Blog','one:Blog','Filter:Category'])]
    private $blogContent;

    /**
     * @ORM\Column(type="string", length=255)
     */
    #[Groups(['read:collection','put:Blog', 'home:Blog','one:Blog','Filter:Category'])]
    private $description;
     ...
     *  @ORM\JoinColumn(nullable=true)
     */
    #[Groups(['read:item','put:Blog', 'home:Blog','one:Blog','Filter:Category'])]
    private $Category;

    #[Groups(['read:item','read:collection','one:Blog','put:Blog','Filter:Category'])]
    private $success = true;

    /**
     * @ORM\Column(type="string", length=80)
     */
    #[Groups(['read:item','read:collection', 'home:Blog','one:Blog','Filter:Category'])]
    private $owner;
